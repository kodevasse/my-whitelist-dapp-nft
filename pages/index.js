  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to PDPkrypto test NFT mint</h1>
          <div className={styles.description}>
            Its is a free NFT mint project for earlybirds.<br></br> The NFT
            could hold value in the future 😯
          </div>
          <div className={styles.description}>
